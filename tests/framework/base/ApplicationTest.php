...
class ApplicationTest extends TestCase
{
    ...
    public function testBootstrap(): void
    {
        ...
        $this->assertSame('Bootstrap with yii\base\Component', Yii::getLogger()->messages[1][0]);
        $this->assertSame('Bootstrap with yiiunit\framework\base\BootstrapComponentMock::bootstrap()', Yii::getLogger()->messages[2][0]);
        $this->assertSame('Loading module: moduleX', Yii::getLogger()->messages[3][0]);
        $this->assertSame('Bootstrap with yii\base\Module', Yii::getLogger()->messages[4][0]);
        $this->assertSame('Bootstrap with Closure', Yii::getLogger()->messages[5][0]);
    }
